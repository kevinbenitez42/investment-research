...
class LineChartPlotter:
    ...
    def plot_candlestick_drawdown_recovery_profile(
        ...
        """
        from .views.risk_profiles import plot_candlestick_drawdown_recovery_view
        ...
        return plot_candlestick_drawdown_recovery_view(
            ...
            candlestick_bollinger_window=candlestick_bollinger_window,
            candlestick_mapped_drawdown_windows=candlestick_mapped_drawdown_windows,
            timeframe_options=timeframe_options,
            default_timeframe_label=default_timeframe_label,
            template=template,
        )
    ...
    def plot_momentum_window_diagnostics(
        ...
        """
        from .views.momentum_diagnostics import (
        ...
        return {
            "optimal_window": plot_optimal_window_view(
                diagnostics_context=diagnostics_context,
                ticker_label=ticker_label,
                template=template,
            ),
            "optimal_window_histogram": plot_optimal_window_histogram_view(
                diagnostics_context=diagnostics_context,
                ticker_label=ticker_label,
                template=template,
            ),
            "sharpe_mean_median": plot_sharpe_mean_median_view(
                diagnostics_context=diagnostics_context,
                ticker_label=ticker_label,
                template=template,
            ),
            "volatility_mean_median": plot_volatility_mean_median_view(
                diagnostics_context=diagnostics_context,
                ticker_label=ticker_label,
                template=template,
            ),
            "sharpe_surface_3d": plot_sharpe_surface_view(
                diagnostics_context=diagnostics_context,
                ticker_label=ticker_label,
                template=template,
            ),
