...
- continue extracting notebook-specific visualization blocks from `Research/Single Asset Profile/Pricing/Momentum & Efficiency.ipynb` into `Quantapp/visualization/views`, using Block 7 as the pilot and then working through Blocks 8-15
